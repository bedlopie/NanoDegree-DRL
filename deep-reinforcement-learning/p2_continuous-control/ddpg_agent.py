...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, GPU, LEARN_EVERY, LEARN_REPEAT, BUFFER_SIZE, BATCH_SIZE, GAMMA, TAU, Actor_network, LR_ACTOR, Critic_network, LR_CRITIC, WEIGHT_DECAY):
