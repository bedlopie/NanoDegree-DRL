...
class DDPG_Agent():
    ...
    def __init__(self, state_size, action_size, nb_agent, id, random_seed, GPU, LEARN_EVERY, LEARN_REPEAT, BUFFER_SIZE, BATCH_SIZE, GAMMA, TAU, Actor_network, LR_ACTOR, Critic_network, LR_CRITIC, WEIGHT_DECAY):
    ...
    def learn(self, experiences, gamma):
        ...
        # Compute critic loss
        Q_expected = self.critic_local(states, actions[self.id])
